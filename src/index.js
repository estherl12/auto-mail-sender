...
var filePath = path.resolve(__dirname, 'Book1.xlsx');
var getCellValue = function (row, cellIndex) {
    var cell = row.getCell(cellIndex);
    console.log(cell.value);
    return cell.value ? cell.value.toString() : '';
};
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var workbook, content, worksheet, rowStartIndex, numberOfRows, rows, students;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                content = _b.sent();
                worksheet = content.worksheets[1];
                rowStartIndex = 2;
